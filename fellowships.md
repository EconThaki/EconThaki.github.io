...
<div style="display:flex; gap:32px; flex-wrap:wrap; margin-top:24px;">
  ...
  <div style="flex:1; min-width:220px; background:#f9f9f9; border-left:4px solid #2C7A7B; padding:16px; border-radius:4px;">
    ...
    <a href="/voces/2026/03/01/voces_ashley_ccanto.html" style="display:inline-block; background:#2C7A7B; color:white; padding:8px 16px; border-radius:4px; text-decoration:none; font-size:0.85em;">Leer entrevista →</a>
  </div>
  ...
  <div style="flex:1; min-width:220px; background:#f9f9f9; border-left:4px solid #2C7A7B; padding:16px; border-radius:4px;">
    ...
    <a href="/voces/2026/03/01/voces_antony_barra.html" style="display:inline-block; background:#2C7A7B; color:white; padding:8px 16px; border-radius:4px; text-decoration:none; font-size:0.85em;">Leer entrevista →</a>
  </div>
  ...
  <div style="flex:1; min-width:220px; background:#f9f9f9; border-left:4px solid #2C7A7B; padding:16px; border-radius:4px;">
    ...
    <a href="/voces/2026/03/01/voces_alexis_minaya.html" style="display:inline-block; background:#2C7A7B; color:white; padding:8px 16px; border-radius:4px; text-decoration:none; font-size:0.85em;">Leer entrevista →</a>
  </div>
